...
// Component
const LanguageSelect = ({ language = DEFAULT_LANGUAGE, onChange }: LanguageSelectProps) => {
  // Prepare data
  const data = ISO_6391_Languages.getLanguages(['en', 'de', 'pl', 'fr', 'it', 'es']).map(({ name, nativeName }) => {
    return {
